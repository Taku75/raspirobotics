...
public:
  ...
  OdometerBase()
  {
    ...
    local_nh.param("base_link_frame_id", base_link_frame_id_, std::string("/base_footprint"));
    local_nh.param("sensor_frame_id", sensor_frame_id_, std::string("/stereo_optical_frame"));
